...
public class MerkleDeserializer {
  
  public MerkleDeserializer() {}
   ...
   * @return
   */
  public MerkleTree deserialize(byte[] serializedTree) {
    ...
    // TODO: the third arg is WRONG - placeholder for height of tree
    MerkleTree mtree = new MerkleTree(root, totnodes, height, leafSigs);
    return mtree;
  }
  
  private static boolean signaturesEqual(byte[] sig, byte[] sig2) {
  ...
  void readNextSignature(ByteBuffer buf, Node nd) {
